...
import { searchHrReminder } from "./service";
/**
...
const Reminders: FC = () => {
  ...
  useEffect(() => {
    searchHrReminder(Number(id), "").then(({ data }) => {
      setData(data);
    });
  }, []);

  const handleSearchIcon = (e: any) => {
    searchHrReminder(Number(id), value).then(({ data }) => {
      setData(data);
    });
  };
              ...
              >
                {data.map((val: any) => (
                  ...
                  >
                    ...
                    >
                      <Link
                        to={`../reminder/edit/${val.participantId}/${val.participantReminderId}`}
                      >
                        Select
                      </Link>
                    </TableCell>
