...
import { deleteHrAttachments } from "../../../pages/hr/attachments/service";
import MoreHorizIcon from "@mui/icons-material/MoreHoriz";
import { Box, Button, Modal, MenuItem } from "@mui/material";
import React, { useContext } from "react";
import { useNavigate, useParams } from "react-router-dom";
import type { FC, MouseEventHandler } from "react";
import { Attachment } from "../../../pages/hr/attachments/AttachmentsDatatypes";
 ...
 * `EditIcon` is used to show edit options on *AttachmentsPage* \
 * of *HR* module.
 */
const EditIcon: FC = () => {
  ...
  const handleDelete: MouseEventHandler<HTMLElement> = (event) => {
    ...
    deleteHrAttachments(Number(childId)).then(() => {
