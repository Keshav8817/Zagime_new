...
import { deleteICAppointment } from "../../../pages/ic/appointments/service";
...
const EditIcon: FC<any> = ({ setDisabled, icappointmentId, targetValue }) => {
  ...
  const handleDelete = () => {
    deleteICAppointment(Number(childId)).then(() => {
